...
>
> 完整算法原理、实验数据与分析见 [📘 设计报告 (docs/report.md)](docs/report.md)。
> 答辩问答指南见 [🎤 答辩指南 (docs/guide.md)](docs/guide.md)。
> 原始课题要求见 [📄 课题描述 (docs/task.md)](docs/task.md)。
...
更详细的数据表格、算法原理、误差分析见 [报告](docs/report.md)。
...
完整推导和代码注释见 [docs/report.md](docs/report.md) 第 3 节。
